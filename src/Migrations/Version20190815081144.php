...
final class Version20190815081144 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        $this->addSql('CREATE TABLE `projects` (
            ...
            CONSTRAINT `fk_project_creator` FOREIGN KEY (`creator`) REFERENCES `user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
            CONSTRAINT `fk_project_modifier` FOREIGN KEY (`modifier`) REFERENCES `user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
        ...
        $this->addSql('CREATE TABLE `projects` (
            ...
            `seo_link` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
            `is_public` tinyint(1) NOT NULL,
            `state_fk` int(11) UNSIGNED NOT NULL,
            `created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
            `original_link` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
            `creator` int(11) UNSIGNED NOT NULL,
            `modified` datetime DEFAULT NULL,
        ...
        */
        ...
        $this->addSql('ALTER TABLE `projects`
            ADD PRIMARY KEY (`id`),
            ADD KEY `fk_project_modifier` (`modifier`),
            ADD KEY `fk_project_state` (`state_fk`),
            ADD KEY `fk_project_creator` (`creator`);');
        */
        /** Auto Increment */
        /*
        $this->addSql('ALTER TABLE `projects`
        ...
        */
        ...
        /*
        $this->addSql('ALTER TABLE `projects`
            ADD CONSTRAINT `fk_project_creator` FOREIGN KEY (`creator`) REFERENCES `user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
            ADD CONSTRAINT `fk_project_modifier` FOREIGN KEY (`modifier`) REFERENCES `user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
            ADD CONSTRAINT `fk_project_state` FOREIGN KEY (`state_fk`) REFERENCES `project_states` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
            COMMIT;');
        */
    }
